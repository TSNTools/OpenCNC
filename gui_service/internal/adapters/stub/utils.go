...
var (
	defaultMonitorServiceAddress = configuration.GetEnv("MONITOR_SERVICE_HOST", "localhost") +
		":" + configuration.GetEnv("MONITOR_SERVICE_PORT", "5151")
	defaultMainServiceAddress = configuration.GetEnv("MAIN_SERVICE_HOST", "localhost") +
		":" + configuration.GetEnv("MAIN_SERVICE_GRPC_PORT", "5153")
)
